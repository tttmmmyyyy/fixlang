...
@rust_str.3 = private unnamed_addr constant [20 x i8] c"Index out of range!\00", align 1
@name_of_obj.4 = private unnamed_addr constant [38 x i8] c"\\value->(writeArray! array idx value)\00", align 1
@name_of_obj.6 = private unnamed_addr constant [46 x i8] c"\\idx->(\\value->(writeArray! array idx value))\00", align 1
@name_of_obj.8 = private unnamed_addr constant [56 x i8] c"\\array->(\\idx->(\\value->(writeArray! array idx value)))\00", align 1
@name_of_obj.13 = private unnamed_addr constant [27 x i8] c"writeArray array idx value\00", align 1
@rust_str.14 = private unnamed_addr constant [20 x i8] c"Index out of range!\00", align 1
@name_of_obj.15 = private unnamed_addr constant [37 x i8] c"\\value->(writeArray array idx value)\00", align 1
@name_of_obj.16 = private unnamed_addr constant [45 x i8] c"\\idx->(\\value->(writeArray array idx value))\00", align 1
@name_of_obj.17 = private unnamed_addr constant [55 x i8] c"\\array->(\\idx->(\\value->(writeArray array idx value)))\00", align 1
@rust_str.20 = private unnamed_addr constant [20 x i8] c"Index out of range!\00", align 1
@name_of_obj.21 = private unnamed_addr constant [28 x i8] c"\\idx->(readArray array idx)\00", align 1
@name_of_obj.22 = private unnamed_addr constant [38 x i8] c"\\array->(\\idx->(readArray array idx))\00", align 1
@name_of_obj.25 = private unnamed_addr constant [20 x i8] c"newArray size value\00", align 1
@name_of_obj.26 = private unnamed_addr constant [30 x i8] c"\\value->(newArray size value)\00", align 1
@name_of_obj.27 = private unnamed_addr constant [39 x i8] c"\\size->(\\value->(newArray size value))\00", align 1
@name_of_obj.30 = private unnamed_addr constant [14 x i8] c"\\x->(fix f x)\00", align 1
@name_of_obj.31 = private unnamed_addr constant [20 x i8] c"\\f->(\\x->(fix f x))\00", align 1
@name_of_obj.34 = private unnamed_addr constant [11 x i8] c"eq lhs rhs\00", align 1
@name_of_obj.36 = private unnamed_addr constant [19 x i8] c"\\rhs->(eq lhs rhs)\00", align 1
@name_of_obj.37 = private unnamed_addr constant [27 x i8] c"\\lhs->(\\rhs->(eq lhs rhs))\00", align 1
@name_of_obj.40 = private unnamed_addr constant [12 x i8] c"add lhs rhs\00", align 1
@name_of_obj.42 = private unnamed_addr constant [20 x i8] c"\\rhs->(add lhs rhs)\00", align 1
@name_of_obj.43 = private unnamed_addr constant [28 x i8] c"\\lhs->(\\rhs->(add lhs rhs))\00", align 1
@name_of_obj.44 = private unnamed_addr constant [2 x i8] c"3\00", align 1
@name_of_obj.45 = private unnamed_addr constant [2 x i8] c"5\00", align 1
...
entry:
  ...
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @name_of_obj.8, i32 0, i32 0))
  ...
  %call_runtime5 = call i64 @report_malloc(i8* %pointer_cast4, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @name_of_obj.17, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.9, void (i8*)** %ptr_to_dtor_field8, align 8
  ...
  store i8* (i8*, i8*)* @lambda.10, i8* (i8*, i8*)** %ptr_to_field10, align 8
  ...
  %call_runtime15 = call i64 @report_malloc(i8* %pointer_cast14, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @name_of_obj.22, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.9, void (i8*)** %ptr_to_dtor_field18, align 8
  ...
  store i8* (i8*, i8*)* @lambda.18, i8* (i8*, i8*)** %ptr_to_field20, align 8
  ...
  %call_runtime25 = call i64 @report_malloc(i8* %pointer_cast24, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @name_of_obj.27, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.9, void (i8*)** %ptr_to_dtor_field28, align 8
  ...
  store i8* (i8*, i8*)* @lambda.23, i8* (i8*, i8*)** %ptr_to_field30, align 8
  ...
  %call_runtime35 = call i64 @report_malloc(i8* %pointer_cast34, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @name_of_obj.31, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.9, void (i8*)** %ptr_to_dtor_field38, align 8
  ...
  store i8* (i8*, i8*)* @lambda.28, i8* (i8*, i8*)** %ptr_to_field40, align 8
  ...
  %call_runtime45 = call i64 @report_malloc(i8* %pointer_cast44, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @name_of_obj.37, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.9, void (i8*)** %ptr_to_dtor_field48, align 8
  ...
  store i8* (i8*, i8*)* @lambda.32, i8* (i8*, i8*)** %ptr_to_field50, align 8
  ...
  %call_runtime55 = call i64 @report_malloc(i8* %pointer_cast54, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @name_of_obj.43, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.9, void (i8*)** %ptr_to_dtor_field58, align 8
  ...
  store i8* (i8*, i8*)* @lambda.38, i8* (i8*, i8*)** %ptr_to_field60, align 8
  ...
  %call_runtime65 = call i64 @report_malloc(i8* %pointer_cast64, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @name_of_obj.44, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.41, void (i8*)** %ptr_to_dtor_field68, align 8
  ...
  store i64 3, i64* %ptr_to_field70, align 4
  %pointer_cast71 = bitcast { { i64, void (i8*)*, i64 }, i64 }* %ptr_to_obj63 to i8*
  %pointer_cast72 = bitcast i8* %pointer_cast61 to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)* }*
  ...
  %call_lambda = tail call i8* %field_value(i8* %pointer_cast71, i8* %pointer_cast61)
  ...
  %call_runtime77 = call i64 @report_malloc(i8* %pointer_cast76, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @name_of_obj.45, i32 0, i32 0))
  ...
  store void (i8*)* @dtor.41, void (i8*)** %ptr_to_dtor_field80, align 8
  ...
  store i64 5, i64* %ptr_to_field82, align 4
  ...
  %pointer_cast88 = bitcast i8* %call_lambda87 to { { i64, void (i8*)*, i64 }, i64 }*
  ...
  call void @release_obj(i8* %call_lambda87)
...
entry:
  ...
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @name_of_obj.6, i32 0, i32 0))
...
entry:
  ...
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast1, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @name_of_obj.4, i32 0, i32 0))
...
cont_bb:                                          ; preds = %after_loop, %entry
  ...
  %is_out_of_ramge = icmp uge i64 %field_value6, %field_value26
  br i1 %is_out_of_ramge, label %out_of_range_bb, label %in_range_bb
...
out_of_range_bb:                                  ; preds = %cont_bb
  %call_runtime29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @rust_str.3, i32 0, i32 0))
  call void @abort()
  unreachable

in_range_bb:                                      ; preds = %cont_bb
  %ptr_to_field30 = getelementptr inbounds { i64, i8** }, { i64, i8** }* %array_field_phi, i32 0, i32 0
  %field_value31 = load i64, i64* %ptr_to_field30, align 4
  %ptr_to_field32 = getelementptr inbounds { i64, i8** }, { i64, i8** }* %array_field_phi, i32 0, i32 1
  %field_value33 = load i8**, i8*** %ptr_to_field32, align 8
  %ptr_to_elem_of_array = getelementptr i8*, i8** %field_value33, i64 %field_value6
  %elem = load i8*, i8** %ptr_to_elem_of_array, align 8
  call void @release_obj(i8* %elem)
  store i8* %0, i8** %ptr_to_elem_of_array, align 8
  %pointer_cast34 = bitcast { { i64, void (i8*)*, i64 }, { i64, i8** } }* %array_phi to i8*
  ret i8* %pointer_cast34
}
...
entry:
  ...
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }*
  %pointer_cast = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @name_of_obj.16, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
...
entry:
  ...
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }*
  %pointer_cast1 = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast1, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @name_of_obj.15, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
  ...
  store i64 %call_runtime, i64* %ptr_to_obj_id, align 4
  %ptr_to_field2 = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }* %ptr_to_obj, i32 0, i32 1
  store i8* (i8*, i8*)* @lambda.12, i8* (i8*, i8*)** %ptr_to_field2, align 8
  %ptr_to_field3 = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }* %ptr_to_obj, i32 0, i32 2
  store i8* %0, i8** %ptr_to_field3, align 8
  %ptr_to_field4 = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8*, i8* }* %ptr_to_obj, i32 0, i32 3
  store i8* %field_value, i8** %ptr_to_field4, align 8
...
shared_bb:                                        ; preds = %entry
  ...
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, { i64, i8** } }*
  %pointer_cast11 = bitcast { { i64, void (i8*)*, i64 }, { i64, i8** } }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast11, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @name_of_obj.13, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, { i64, i8** } }, { { i64, void (i8*)*, i64 }, { i64, i8** } }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
...
cont_bb:                                          ; preds = %after_loop, %entry
  ...
  %is_out_of_ramge = icmp uge i64 %field_value6, %field_value25
  br i1 %is_out_of_ramge, label %out_of_range_bb, label %in_range_bb
...
out_of_range_bb:                                  ; preds = %cont_bb
  %call_runtime28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @rust_str.14, i32 0, i32 0))
  call void @abort()
  unreachable

in_range_bb:                                      ; preds = %cont_bb
  %ptr_to_field29 = getelementptr inbounds { i64, i8** }, { i64, i8** }* %array_field_phi, i32 0, i32 0
  %field_value30 = load i64, i64* %ptr_to_field29, align 4
  %ptr_to_field31 = getelementptr inbounds { i64, i8** }, { i64, i8** }* %array_field_phi, i32 0, i32 1
  %field_value32 = load i8**, i8*** %ptr_to_field31, align 8
  %ptr_to_elem_of_array = getelementptr i8*, i8** %field_value32, i64 %field_value6
  %elem = load i8*, i8** %ptr_to_elem_of_array, align 8
  call void @release_obj(i8* %elem)
  store i8* %0, i8** %ptr_to_elem_of_array, align 8
  %pointer_cast33 = bitcast { { i64, void (i8*)*, i64 }, { i64, i8** } }* %array_phi to i8*
  ret i8* %pointer_cast33
}
...
entry:
  ...
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }*
  %pointer_cast = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @name_of_obj.21, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
...
entry:
  ...
  %is_out_of_ramge = icmp uge i64 %field_value4, %field_value6
  br i1 %is_out_of_ramge, label %out_of_range_bb, label %in_range_bb

out_of_range_bb:                                  ; preds = %entry
  %call_runtime = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @rust_str.20, i32 0, i32 0))
  call void @abort()
  unreachable

in_range_bb:                                      ; preds = %entry
  %ptr_to_field9 = getelementptr inbounds { i64, i8** }, { i64, i8** }* %array_field, i32 0, i32 0
  %field_value10 = load i64, i64* %ptr_to_field9, align 4
  %ptr_to_field11 = getelementptr inbounds { i64, i8** }, { i64, i8** }* %array_field, i32 0, i32 1
  %field_value12 = load i8**, i8*** %ptr_to_field11, align 8
  %ptr_to_elem_of_array = getelementptr i8*, i8** %field_value12, i64 %field_value4
  %elem = load i8*, i8** %ptr_to_elem_of_array, align 8
  call void @retain_obj(i8* %elem)
  %pointer_cast13 = bitcast { { i64, void (i8*)*, i64 }, { i64, i8** } }* %pointer_cast1 to i8*
  call void @release_obj(i8* %pointer_cast13)
  ret i8* %elem
}
...
entry:
  ...
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }*
  %pointer_cast = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @name_of_obj.26, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
  ...
  store i64 %call_runtime, i64* %ptr_to_obj_id, align 4
  %ptr_to_field = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 1
  store i8* (i8*, i8*)* @lambda.24, i8* (i8*, i8*)** %ptr_to_field, align 8
  %ptr_to_field1 = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 2
  store i8* %0, i8** %ptr_to_field1, align 8
  %pointer_cast2 = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  ret i8* %pointer_cast2
...
entry:
  ...
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast4, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @name_of_obj.25, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, { i64, i8** } }, { { i64, void (i8*)*, i64 }, { i64, i8** } }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
...
entry:
  ...
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }*
  %pointer_cast = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @name_of_obj.30, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
...
define i8* @lambda.32(i8* %0, i8* %1) {
entry:
  call void @release_obj(i8* %1)
  %malloccall = tail call i8* @malloc(i32 ptrtoint ({ { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* getelementptr ({ { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* null, i32 1) to i32))
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }*
  %pointer_cast = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @name_of_obj.36, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
  ...
  store i64 %call_runtime, i64* %ptr_to_obj_id, align 4
  %ptr_to_field = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 1
  store i8* (i8*, i8*)* @lambda.33, i8* (i8*, i8*)** %ptr_to_field, align 8
  %ptr_to_field1 = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 2
  store i8* %0, i8** %ptr_to_field1, align 8
  %pointer_cast2 = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  ret i8* %pointer_cast2
...
entry:
  ...
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast7, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @name_of_obj.34, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8 }, { { i64, void (i8*)*, i64 }, i8 }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
  store void (i8*)* @dtor.35, void (i8*)** %ptr_to_dtor_field, align 8
  %ptr_to_obj_id = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 2
  store i64 %call_runtime, i64* %ptr_to_obj_id, align 4
...
define void @dtor.35(i8* %0) {
entry:
  ret void
}

define i8* @lambda.38(i8* %0, i8* %1) {
entry:
  call void @release_obj(i8* %1)
  %malloccall = tail call i8* @malloc(i32 ptrtoint ({ { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* getelementptr ({ { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* null, i32 1) to i32))
  %ptr_to_obj = bitcast i8* %malloccall to { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }*
  %pointer_cast = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @name_of_obj.42, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
  ...
  store i64 %call_runtime, i64* %ptr_to_obj_id, align 4
  %ptr_to_field = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 1
  store i8* (i8*, i8*)* @lambda.39, i8* (i8*, i8*)** %ptr_to_field, align 8
  %ptr_to_field1 = getelementptr inbounds { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }, { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj, i32 0, i32 2
  store i8* %0, i8** %ptr_to_field1, align 8
  %pointer_cast2 = bitcast { { i64, void (i8*)*, i64 }, i8* (i8*, i8*)*, i8* }* %ptr_to_obj to i8*
  ret i8* %pointer_cast2
...
entry:
  ...
  %call_runtime = call i64 @report_malloc(i8* %pointer_cast7, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @name_of_obj.40, i32 0, i32 0))
  %ptr_to_control_block = getelementptr inbounds { { i64, void (i8*)*, i64 }, i64 }, { { i64, void (i8*)*, i64 }, i64 }* %ptr_to_obj, i32 0, i32 0
  %ptr_to_refcnt = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 0
  store i64 1, i64* %ptr_to_refcnt, align 4
  %ptr_to_dtor_field = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 1
  store void (i8*)* @dtor.41, void (i8*)** %ptr_to_dtor_field, align 8
  %ptr_to_obj_id = getelementptr inbounds { i64, void (i8*)*, i64 }, { i64, void (i8*)*, i64 }* %ptr_to_control_block, i32 0, i32 2
  store i64 %call_runtime, i64* %ptr_to_obj_id, align 4
