...
main : IO () = (
    ...
    let (parr, _) = PunchedArray::_unsafe_punch_bounds_unchecked(1, [[1],[2],[3]]);
    let a1 = PunchedArray::_unsafe_plug_bounds_unchecked([10], parr);
    let a2 = PunchedArray::_unsafe_plug_bounds_unchecked([20], parr);
...
main : IO () = (
    ...
    // stays valid.
    let (parr, elm) = PunchedArray::_unsafe_punch_bounds_unchecked(0, [[7],[8],[9]]);
    eval parr;
