...
pub trait LLVMGen: DynClone + Send + Sync {
    ...
    // PROOF: D/A, P7a, P7d, P7e, (P-insert) (dev-docs/proof/rc_ir/borrow-cancel)
    ...
    // PROOF: D/A, P1, P2, P3, P4, P7a, P7d, P7e, P26, P28, (P-insert) (dev-docs/proof/rc_ir/borrow-cancel)
    fn result_prov(
        &self,
