...
// PROOF: D/A, P1, P2, P7a, P7d, P7e, P26 (dev-docs/proof/rc_ir/borrow-cancel)
pub fn make_std_mod(config: &Configuration) -> Result<Program, Errors> {
    ...
    errors.eat_err(fix_module.add_global_value(
        FullName::from_strs(&[STD_NAME, ARRAY_NAME], "_unsafe_truncate_bounds_unchecked"),
    ...
    errors.eat_err(fix_module.add_global_value(
        FullName::from_strs(
            &[STD_NAME, ARRAY_NAME],
            "_unsafe_set_capacity_bounds_unchecked",
        ),
        array_set_capacity_bounds_unchecked(),
        None,
        None,
