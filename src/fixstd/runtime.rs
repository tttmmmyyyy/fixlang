...
fn build_get_argc_function<'c, 'm>(gc: &mut Generator<'c, 'm>, mode: BuildMode) {
    ...
    let argc_ptr = gc
        ...
        .into_pointer_value();
    let argc = gc
        .build_load(MemoryRegion::Value, argc_gv_ty.into(), argc_ptr, "argc")
        .into_int_value();
...
fn build_get_argv_function<'c, 'm>(gc: &mut Generator<'c, 'm>, mode: BuildMode) {
    ...
    let argv_gv_ptr = gc
        ...
        .into_pointer_value();
    let argv_ptr = gc
        .build_load(MemoryRegion::Value, ptr_ty.into(), argv_gv_ptr, "argv")
        .into_pointer_value();
    ...
    let arg_ptr = gc
        .build_load(MemoryRegion::Value, ptr_ty.into(), elem_ptr, "arg_ptr")
        .into_pointer_value();
