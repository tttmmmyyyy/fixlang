...
use lsp_types::{
    ...
    ProgressParamsValue, ProgressToken, PublishDiagnosticsParams, ReferenceParams, RenameOptions,
    RenameParams, SaveOptions, SemanticTokensFullOptions, SemanticTokensOptions,
