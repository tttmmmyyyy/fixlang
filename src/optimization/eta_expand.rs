...
Since multi-parameter lambdas are generated by the uncurrying optimization, this optimization is applied before the uncurrying optimization.
*/
...
fn run_on_symbol(sym: &mut InstantiatedSymbol) {
    if is_std_fix(&sym.instantiated_name) {
