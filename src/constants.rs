...
/// holes (e.g. `#typehole0`). Each `_` in a type annotation gets a
/// distinct name so that, for example, the two holes in `(_, _)` stay
...
/// user.
pub const TYPE_HOLE_VAR_PREFIX: &str = "#typehole";
