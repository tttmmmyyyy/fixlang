...
- #588: An `F32` literal now takes the `F32` value nearest the decimal written. It was read as an `F64` and then narrowed, and rounding twice can land one step past the value rounding once gives: `1.000000178813934326171874999999_F32` sits just below the midpoint of two `F32` values, so it takes the lower one, where it used to take the higher.
