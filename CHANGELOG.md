...
- #573: A string literal now takes `\'` for a single quote, as a `U8` literal does. It was reported as `Expected string_char.`, although a single quote written on its own has always been accepted.
