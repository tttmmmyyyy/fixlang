...
- #619, #670: `F64::to_string` and `F32::to_string` now write a number in its shortest round-trip decimal form, where they used to write the six places `%f` gives by default. `1.0 / 3.0` is `0.3333333333333333` and `1.0e-10` is `1e-10`, where they were `0.333333` and `0.000000`. A number of ordinary size is written with a point — `1.0`, `0.1`, `123456.789` — and a very large or very small one with a power of ten, so `1.0e300` is `1e300`. A program that shows a floating point number shows a different text than it did. `to_string_precision` and `to_string_exp` write what they wrote before.
