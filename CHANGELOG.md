...
- Added the `--develop-mode` compiler option. It builds your program with the consistency checks the compiler's own test suite builds under: they cost run time, and they stop the program where one of them fails.
