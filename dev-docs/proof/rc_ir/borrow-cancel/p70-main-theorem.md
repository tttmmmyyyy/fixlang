...
**T** (パイプラインが保存するもの)
    ...
    ASSUME NEW p0 : RcProgram, NEW type_env : TypeEnv, NEW develop_mode : bool,
      ...
      H3. 第 4 節の仮定がすべて成り立つ。**H3 が量化する集合は、第 4 節が挙げるものの全体で
          ...
          拾う項目は 27 個であり (第 3 節が 27 個すべてを並べる)、そのうち A1 と A2 を `p0` に
...
**残っているのは検証である。** README 第 7.1 節の表は P26 を 2 行に分けて記録する -- `cancel` の
...
どこまで証明されているかは README 第 7.1 節の表が述べる。**T が閉じることは、それらが
