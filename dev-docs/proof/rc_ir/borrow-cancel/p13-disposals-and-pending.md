...
付ける道も取れるが、この文書で `ρ` 歩みを辿る補題 (`L12a`、`L12b`、`L14`、`L15`、`L17`) と D33 の別名類は
...
**言明**。<label name=21f8c06>`ρ` の上のスロット `(x, λ)` について、`o = origin(x, λ).identity()` は `ρ` の上の位置 (D6) --
...
<quote name=d050777 hash=d857848/>
