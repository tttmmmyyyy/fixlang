...
**A19 (i) を閉じたことで、その重みは P28 へ移り、P28 も閉じた** (`p05-holders.md`)。段を 6 種の素動作へ
分解し、各素動作が持ち手ごとの勘定を保つことを示す形である。P28 が D12 を前提に取るので、A19 (i) も
D12 を満たすプログラムについての節になる -- 読み手の量化範囲では A1 と P14 がそれを与える。
