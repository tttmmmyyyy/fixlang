...
| `p10-leaves-and-units.md` | 第 6 周 (494 段) | **0** | **0** | NOT-OBVIOUS 8、README 差し戻し 5 | **2 周続けてゼロ**。NOT-OBVIOUS の修理と、その後の検証 |
| `p11-origin-soundness.md` | 第 5 周 | 4 | 1 | BAD-CITATION 8、NOT-OBVIOUS 7 | 修理済み。**第 6 周の検証** |
...
| `p15-ownership-uniformity.md` | 第 6 周 (383 段) | 0 | **2** | NOT-OBVIOUS 5 | **修理** |
| `p20-borrow-ify.md` | 第 5 周 | 1 | -- | BAD-CITATION 4、NOT-OBVIOUS 6 | 修理済み。**第 6 周の検証** |
| `p30-cancel-walk.md` | 第 5 周 | 4 | -- | UNDEFINED 1、NOT-OBVIOUS 10 | 修理済み。**第 6 周の検証** |
| `p40-cancel-soundness.md` | 第 5 周 | 4 | 2 | BAD-CITATION 4、NOT-OBVIOUS 7 | 修理済み。**第 6 周の検証** |
