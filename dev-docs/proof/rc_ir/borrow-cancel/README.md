...
| P7c, P7f | `p13-disposals-and-pending.md` | 有 | 証明済み (P7c の言明は 2 度書き直した) | 検証は 3 周 (直近の周の指摘 12 件、FALSE 1)。**4 周目が要る** |
...
| P18b | `p13-disposals-and-pending.md` | 有 | 証明済み | 検証は 3 周 (直近の周の指摘 12 件、FALSE 1)。**4 周目が要る** |
| P18c | `p40-cancel-soundness.md` | 有 | 証明済み (A19、P14a、`p13` の `L17` の下で) | 検証は 3 周 (直近の周の指摘 18 件、FALSE 1)。**4 周目が要る** |
| P18a | `p13-disposals-and-pending.md` | 有 | 証明済み (A19 の下で)。A19 (ii-b) は、この証明が要る条件付きの形に書き直した | 検証は 3 周 (直近の周の指摘 12 件、FALSE 1)。**4 周目が要る** |
...
| T | `p70-main-theorem.md` | -- | 証明済み。(T1) から (T4) まで、引用する命題の言明の上で閉じる | 検証は 1 周 (直近の周の指摘 11 件、FALSE 0)。**2 周目が要る** |
