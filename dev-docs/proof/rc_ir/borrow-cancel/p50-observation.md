...
|---|---|---|
| P26 (`cancel` について) | **証明済み** (L7)。第 12 節の項目 4 の下で | **証明済み** (L7a)。同じ前提の下で |
| P26 (`borrow_ify` について) | **証明済み** (L13)。1 つの制御の流れからなる実行について、かつ第 12 節の項目 2・項目 3・項目 4 の下で | 言明が量化しない |
...
(同 項目 3)、そして段が作る活性化の決定性 (同 項目 4) である。
